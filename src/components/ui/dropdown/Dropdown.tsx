    ...
    return (
        <>
            ...
            <div
                ...
                } z-50 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900 ${isMobile ? 'w-auto' : 'w-80 sm:w-96'} ${className} `}
            >
                {/* Contenido con estructura flex que permite scroll interno */}
                <div className={`flex h-full flex-col ${isMobile ? 'pb-safe' : ''}`}>
                    {children}
                </div>
            </div>
        </>
