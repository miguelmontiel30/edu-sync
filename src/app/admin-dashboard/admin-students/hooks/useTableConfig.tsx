...
export function useTableConfig({
    ...
    const deletedStudentColumns: Column<Student>[] = useMemo(
        () => [
            ...
            },
            {
                ...
                header: 'Eliminado el',
                sortable: true,
                render: (student: Student) => <span>{formatDate(student.deleted_at || '')}</span>,
            },
        ],
        [],
    );
    ...
    const deleteConfirmModalConfig = useMemo(
        () => ({
            ...
            message:
                'Estás a punto de eliminar a un estudiante. Esta acción no eliminará permanentemente al estudiante del sistema, sino que lo marcará como inactivo.',
            confirmButton: 'Sí, Eliminar',
            cancelButton: 'Cancelar',
            activeWarning:
                'Este estudiante está activo. Al eliminarlo, se perderán sus asignaciones a grupos y todas sus relaciones activas.',
        }),
        [],
    );
