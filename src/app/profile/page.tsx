...
const ProfileAvatar: React.FC<ProfileAvatarProps> = ({ size, name, imageUrl, className }) => {
    ...
    return (
        <div
            className={`flex items-center justify-center rounded-full bg-purple-500 font-semibold text-white ${currentSizeClass} ${className || ''}`}
        >
            {initials}
        </div>
    );
...
const Card = ({ children, className, ...props }: CardProps) => (
    <div className={`rounded-xl bg-white shadow-lg dark:bg-gray-800 ${className || ''}`} {...props}>
        {children}
    </div>
);
...
const CardHeader = ({ children, className, ...props }: CardHeaderProps) => (
    <div
        className={`border-b border-gray-200 p-6 dark:border-gray-700 ${className || ''}`}
        {...props}
    >
        {children}
    </div>
            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        className="h-auto p-1.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
                    >
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
                    <div>
                        ...
                        <Input
                            ...
                            startIcon={<IconFA icon="user" className="text-gray-400" />}
                        />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={handleInputChange}
                            startIcon={<IconFA icon="calendar-alt" className="text-gray-400" />}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            ...
                            value={userData.curp}
                            onChange={handleInputChange}
                            startIcon={<IconFA icon="id-card" className="text-gray-400" />}
                        />
                    </div>
                    <div className="relative">
                        ...
                        <select
                            ...
                            onChange={handleInputChange}
                            className="w-full rounded-md border border-gray-300 bg-white p-2.5 pl-10 text-gray-900 focus:border-purple-500 focus:ring-purple-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                        >
                        ...
                        <div className="pointer-events-none absolute inset-y-0 left-0 top-7 flex items-center pl-3">
                            <IconFA icon="venus-mars" className="h-5 w-5 text-gray-400" />
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={handleInputChange}
                            startIcon={<IconFA icon="phone" className="text-gray-400" />}
                        />
                    </div>
                </div>
            </CardContent>
            ...
            <CardContent className="space-y-3">
                <div>
                    ...
                    <Input
                        ...
                        name="userLoginEmail"
                        type="email"
                        value={fakeStudentProfileData.userEmail}
                        className="bg-gray-100 dark:bg-gray-700/50"
                        startIcon={<IconFA icon="at" className="text-gray-400" />}
                    />
                </div>
                <div>
...
function ProfileSidebar() {
    ...
    const fullName =
        `${fakeStudentProfileData.firstName} ${fakeStudentProfileData.fatherLastName}`.trim();
        ...
        <div className="space-y-6">
                ...
                <CardContent className="flex flex-col items-center p-0">
                    <div className="group relative mb-4">
                        ...
                        <label
                            ...
                            className="absolute inset-0 flex cursor-pointer items-center justify-center rounded-full bg-black bg-opacity-60 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                        >
                        ...
                        <Button
                            variant="primary"
                            size="sm"
                            className="absolute bottom-0 right-0 flex h-9 w-9 items-center justify-center rounded-full border-2 border-white p-0 shadow-md hover:bg-purple-700 dark:border-gray-800"
                    ...
                    <p className="text-sm font-medium text-purple-600 dark:text-purple-400">
                        {fakeStudentProfileData.studentId}
                    </p>
                    <div className="mt-3">
                        <span className="rounded-full bg-blue-100 px-3 py-1 text-xs font-semibold tracking-wide text-blue-700 dark:bg-blue-900 dark:text-blue-300">
                            Estudiante
                        </span>
                    </div>
                </CardContent>
            ...
            <Card>
                <CardHeader className="flex items-center justify-between">
                    <CardTitle className="flex items-center">
                        <IconFA icon="map-marker-alt" className="mr-2 text-purple-500" /> Ubicación
                        Principal
                    </CardTitle>
                    <Button
                        variant="outline"
                    ...
                    {fakeStudentProfileData.currentAddress ? (
                        <div>
                            <p className="text-sm text-gray-800 dark:text-gray-200">
                                {fakeStudentProfileData.currentAddress.addressLine}
                            </p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                {fakeStudentProfileData.currentAddress.city}, CP{' '}
                                {fakeStudentProfileData.currentAddress.postalCode}
                            </p>
                        </div>
                    ) : (
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            No hay dirección principal registrada.
                        </p>
                    )}
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <CardTitle className="flex items-center">
                            <IconFA icon="map-signs" className="mr-2 text-purple-500" /> Direcciones
                        </CardTitle>
                        <Button
                            variant="outline"
                            size="sm"
                            className="h-auto gap-1 p-1.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
                        >
                ...
                <CardContent className="space-y-3">
                    {[
                        fakeStudentProfileData.currentAddress,
                        {
                            addressLine: '123 Other St, Worksville',
                            city: 'Metropolis',
                            postalCode: '60606',
                            isPrimary: false,
                        },
        ...
        <div className="mb-6">
            ...
            {currentTab === 'information' && (
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div className="order-first lg:order-first lg:col-span-1">
                        <ProfileSidebar />
                    </div>
                    <div className="order-last space-y-6 lg:order-last lg:col-span-2">
                        <PersonalInfoForm />
                        <UserAccountInfo />
                    </div>
                </div>
                    ...
                    <Card>
                        <CardContent>
                            <p className="text-gray-700 dark:text-gray-300">
                                Contenido de Configuración de Cuenta (Placeholder).
                            </p>
                        </CardContent>
                    </Card>
                </div>
            )}
            {currentTab === 'subscription-payments' && (
                <div className="p-4">
                    <Card>
                        <CardContent>
                            <p className="text-gray-700 dark:text-gray-300">
                                Contenido de Suscripción y Pagos (Placeholder).
                            </p>
                        </CardContent>
                    </Card>
                </div>
            ...
            {currentTab === 'notifications' && (
                <div className="p-4">
                    <Card>
                        <CardContent>
                            <p className="text-gray-700 dark:text-gray-300">
                                Contenido de Notificaciones (Placeholder).
                            </p>
                        </CardContent>
                    </Card>
                </div>
            ...
            {currentTab === 'account-security' && (
                <div className="p-4">
                    <Card>
                        <CardContent>
                            <p className="text-gray-700 dark:text-gray-300">
                                Contenido de Seguridad de la Cuenta (Placeholder).
                            </p>
                        </CardContent>
                    </Card>
                </div>
            )}
            {currentTab === 'close-account' && (
                <div className="p-4">
                    <Card>
                        <CardContent>
                            <p className="text-red-600 dark:text-red-400">
                                Contenido para Cerrar Cuenta (Placeholder).
                            </p>
                        </CardContent>
                    </Card>
                </div>
...
export default function ProfilePage() {
    return (
        <div className="mx-auto max-w-screen-2xl md:p-6">
            ...
            <div className="mt-8 flex flex-col justify-end space-y-3 sm:flex-row sm:space-x-3 sm:space-y-0">
                <Button variant="outline" className="w-full sm:w-auto">
                    Cancelar
                </Button>
